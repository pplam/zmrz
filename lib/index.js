...
var _class = function () {
  ...
  _createClass(_class, [{
    ...
    value: function sign(input) {
      ...
      return _crypto2.default.createSign('RSA-SHA1').update(input, 'utf8').sign(key, 'base64');
    }
  }, {
    key: 'verify',
    value: function verify(expected, sign) {
      ...
      return _crypto2.default.createVerify('RSA-SHA1').update(expected, 'utf8').verify(key, sign, 'base64');
    }
  }, {
    key: 'obj2qs',
