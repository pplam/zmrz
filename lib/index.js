...
var _class = function () {
  ...
  _createClass(_class, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                signature = this.sign(this.obj2qs(opts));
    ...
    value: function sign(input) {
      ...
      return _crypto2.default.createSign('RSA-SHA256').update(input, 'utf8').sign(key, 'base64');
    }
  }, {
    key: 'verify',
    value: function verify(expected, sign) {
      ...
      return _crypto2.default.createVerify('RSA-SHA256').update(expected, 'utf8').verify(key, sign, 'base64');
    }
  }, {
    key: 'obj2qs',
    value: function obj2qs(obj) {
