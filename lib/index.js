...
var _class = function () {
  ...
  _createClass(_class, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                url = this.config.url + '?' + _querystring2.default.stringify(opts);
                _context.next = 6;
    ...
    value: function getUrl(bizNO, returnUrl) {
      ...
      var signature = this.sign(this.buildQs(opts));
      opts.sign = signature;

      return this.config.url + '?' + _querystring2.default.stringify(opts);
    }
  }, {
    key: 'sign',
